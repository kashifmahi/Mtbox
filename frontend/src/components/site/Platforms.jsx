...
const meta = [
  { num: "01", image: "https://images.pexels.com/photos/5435079/pexels-photo-5435079.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", accent: "#C9A227" },
  { num: "02", image: "https://images.pexels.com/photos/32299941/pexels-photo-32299941.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", accent: "#00B8D9", fintech: true },
  { num: "03", image: "https://images.pexels.com/photos/399187/pexels-photo-399187.jpeg?auto=compress&cs=tinysrgb&w=1200", accent: "#C9A227" },
  { num: "04", image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=1200", accent: "#C9A227" },
  { num: "05", image: "https://images.unsplash.com/photo-1521292270410-a8c4d716d518?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200", accent: "#00B8D9" },
];
...
export const Platforms = () => {
  const { t } = useLang();
  const chapters = meta.map((m, i) => ({ ...m, ...t.platforms.chapters[i] }));
  return (
    <section id="what-we-do" className="relative bg-[#04101f] py-28 md:py-36 overflow-hidden" data-testid="platforms-section">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        <SectionHeader overline={t.platforms.overline} title={t.platforms.title} />
        {chapters.map((p) => (
          <Chapter key={p.num} p={p} />
        ))}
      </div>
    </section>
  );
