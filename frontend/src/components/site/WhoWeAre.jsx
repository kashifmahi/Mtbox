  ...
  return (
    <section id="who-we-are" className="relative bg-[#071A33] py-28 md:py-40 overflow-hidden" data-testid="who-we-are-section">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        <SectionHeader overline={t.who.overline} title={t.who.title} />
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <Reveal>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <span className="font-grotesk text-[0.68rem] uppercase tracking-[0.2em] text-white/40">{t.who.badge}</span>
            </div>
          </Reveal>

          <div className="space-y-8">
            <Reveal delay={0.1}>
              <p className="text-white/70 leading-relaxed text-base md:text-lg">{t.who.p1}</p>
            </Reveal>
            <Reveal delay={0.2}>
            ...
            <Reveal delay={0.3}>
              <p className="text-white/60 leading-relaxed text-sm md:text-base">{t.who.p2}</p>
            </Reveal>
            ...
            <div className="grid sm:grid-cols-2 gap-6 pt-4">
              <Reveal delay={0.35} className="border border-white/10 bg-white/[0.03] p-7 rounded-sm card-lift card-lift-dark" data-testid="vision-card">
                <div className="overline-label text-[#00B8D9] mb-4">{t.who.visionLabel}</div>
                <p className="font-serif-display text-lg text-white leading-snug">{t.who.vision}</p>
              </Reveal>
              <Reveal delay={0.45} className="border border-white/10 bg-white/[0.03] p-7 rounded-sm card-lift card-lift-dark" data-testid="mission-card">
                <div className="overline-label text-[#C9A227] mb-4">{t.who.missionLabel}</div>
                <p className="font-serif-display text-lg text-white leading-snug">{t.who.mission}</p>
              </Reveal>
            </div>
          </div>
        </div>
